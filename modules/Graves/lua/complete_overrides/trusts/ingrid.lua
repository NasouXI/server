...
m:addOverride("xi.actions.spells.trust.ingrid.onSpellCast", function(caster, target, spell)
    ...
    trust:addGambit(ai.t.SELF, { ai.c.MPP_LT, 20 }, { ai.r.JA, ai.s.SPECIFIC, xi.ja.CONVERT })
    trust:addGambit(ai.t.PARTY, { ai.c.HPP_LT, 25 }, { ai.r.MA, ai.s.HIGHEST, xi.magic.spellFamily.CURE })
    trust:addGambit(ai.t.PARTY, { ai.c.STATUS, xi.effect.SLEEP_I }, { ai.r.MA, ai.s.SPECIFIC, xi.magic.spell.CURAGA })
    trust:addGambit(ai.t.PARTY, { ai.c.STATUS, xi.effect.SLEEP_II }, { ai.r.MA, ai.s.SPECIFIC, xi.magic.spell.CURAGA })
