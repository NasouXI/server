...
m:addOverride("xi.zones.Caedarva_Mire.npcs.Seaprinces_Tombstone.onTrade", function(player, npc, trade)
    ...
    elseif titleCheck and tinninsFang and sarameyasHide and tygersTail and gurfurlursHelmet and medusasArmlet and jajasChestplate and catsEye and imperialGoldPieces then
        player:tradeComplete()
        player:setCharVar("PendingMythic", 1)
